...
public class ExtentReport extends TestListenerAdapter {
	...
	//	htmlReporter.config().setAutoCreateRelativePathMedia(true);
		...
		extent.setSystemInfo("Host Name","Rihda");
	...
	public void onTestFailure(ITestResult tr) {
		...
		String screenshothpath=System.getProperty("user.dir")+"/Screenshot/"+tr.getName()+".png";
		
		File file=new File (screenshothpath);
		
		if(file.exists()) {
			try {
				xTest.fail("Screen shot for the test failed is :"+ xTest.addScreenCaptureFromPath(screenshothpath));
					}catch (IOException e ) {
						e.printStackTrace();
					}
	}
